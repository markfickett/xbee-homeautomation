...
fahrenheit = {
	...
	'series': {
		...
		'0x0013a200408cca0e-AD1': [
			...
			{	'title': 'Living Room (on wires)',
				'lastDate': '2012 Sep 20 02:45:19 UTC',
			},
			{	'title': 'Bedroom (on wires)',
	...
	'annotations': [
		...
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 02:47:40 UTC',
			'shortText': 'C',
			'text': 'calibration: all sensors in same location',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:10:59 UTC',
			'shortText': 'C',
			'text': '72.8 F from calibrated meter',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:13:21 UTC',
			'shortText': 'C',
			'text': '72.9 F',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:17:08 UTC',
			'shortText': 'C',
			'text': '72.6 F',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:19:30 UTC',
			'shortText': 'C',
			'text': '72.8 F',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:21:51 UTC',
			'shortText': 'C',
			'text': '72.8 F',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:27:05 UTC',
			'shortText': 'C',
			'text': '72.8 F',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:50:20 UTC',
			'shortText': 'C',
			'text': '72.4 F',
		},
		{	'series': 'Bedroom (board)',
			'x': '2012 Sep 20 03:52:40 UTC',
			'shortText': 'Ns',
			'text': 'reduce number of sleep periods to 3',
		},
		{	'series': 'Bedroom',
			'x': '2012 Sep 20 03:57:55 UTC',
			'shortText': 'C',
			'text': '72.2 F',
		},
	],
